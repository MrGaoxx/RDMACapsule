...
class SwitchTableWritter {
   ...
   public:
    ...
    // return mcg_id
    uint32_t multicast_group_add(uint32_t src_addr, uint32_t dqp_num, uint32_t sqp_num, uint32_t dst_addr1, uint32_t dqp1, uint32_t dst_addr2,
                                 uint32_t dqp2, uint32_t dst_addr3, uint32_t dqp3);
    uint32_t multicast_group_add(uint32_t src_addr, uint32_t dqp_num, uint32_t sqp_num, uint32_t dst_addr1, uint32_t dqp1, uint32_t dst_addr2,
                                 uint32_t dqp2);
    int multicast_group_del(uint32_t mcg_id, uint32_t src_addr, uint32_t dqp_num);
